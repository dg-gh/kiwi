...
kiwi::glyph_3d& kiwi::glyph_3d::update_text(std::size_t glyph_number, char glyph) noexcept
{
	...
	m_atlas_coordinate_function(static_cast<int>(glyph), static_cast<GLfloat*>(m_XY) + 2);
...
kiwi::glyph_3d& kiwi::glyph_3d::update_glyph(std::size_t glyph_number, int glyph) noexcept
{
	...
	m_atlas_coordinate_function(glyph, static_cast<GLfloat*>(m_XY) + 2);
	m_XY_UV_coordinates.substitute(static_cast<GLfloat*>(m_XY) + 2,
		glyph_number * (4 * sizeof(GLfloat)) + (2 * sizeof(GLfloat)), 2 * sizeof(GLfloat));
...
kiwi::glyph_3d& kiwi::glyph_3d::move_to(GLfloat X, GLfloat Y) noexcept
{
...
kiwi::glyph_3d& kiwi::glyph_3d::move_X_to(GLfloat X) noexcept
{
	m_XY[0] = m_origin[0] + X * m_glyph_offset;
	return *this;
}

kiwi::glyph_3d& kiwi::glyph_3d::move_Y_to(GLfloat Y) noexcept
{
	m_XY[1] = m_origin[1] - Y * m_endline_offset;
	return *this;
}

kiwi::glyph_3d& kiwi::glyph_3d::move(GLfloat X_offset, GLfloat Y_offset) noexcept
{
