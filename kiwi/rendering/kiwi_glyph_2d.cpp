...
kiwi::glyph_2d& kiwi::glyph_2d::move_to(GLfloat X, GLfloat Y) noexcept
{
...
kiwi::glyph_2d& kiwi::glyph_2d::move_X_to(GLfloat X) noexcept
{
	m_XY[0] = m_origin[0] + X * m_glyph_offset;
	return *this;
}

kiwi::glyph_2d& kiwi::glyph_2d::move_Y_to(GLfloat Y) noexcept
{
	m_XY[1] = m_origin[1] - Y * m_endline_offset;
	return *this;
}

kiwi::glyph_2d& kiwi::glyph_2d::move(GLfloat X_offset, GLfloat Y_offset) noexcept
{
...
void kiwi::glyph_2d::generate_default_atlas_texture()
{
	std::string str =
		...
		"00003c070030c0c0303c0c0ff00ff030000e0c00c0c0ec1ccc0cf000c0c100c000300c0000000000300000ff30ce0e00ccf000007000e08f700300c000000000"
		...
		"0cf03c10c00ff1cf70ef1cf70ef3ce70ef3cf30303c0c0303c1e0303cff08300c0007087e00000c00000cff073000703700000c100830ef10c00000000000000"
