...
namespace kiwi
{
	...
	public:
		...
		kiwi::bloom& init(std::size_t screen_width, std::size_t screen_height, bool extended = true, kiwi::texture_sampling sampling = kiwi::texture_sampling::unique) noexcept;
