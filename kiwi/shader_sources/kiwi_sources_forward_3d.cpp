...
const char* const kiwi::source::forward_3d_color_gradient::vertex_shader() noexcept
{
	return
		"	#version 430 core																					\n"
		"	layout (location = 0) in vec3 in_XYZ;																\n"
...
const char* const kiwi::source::forward_3d_color_gradient::fragment_shader() noexcept
{
	return
		"	#version 430 core																					\n"
		"	in vec3 moved_XYZ;																					\n"
...
const char* const kiwi::source::forward_3d_texture::vertex_shader() noexcept
{
	return
		"	#version 430 core																					\n"
		"	layout (location = 0) in vec3 in_XYZ;																\n"
...
const char* const kiwi::source::forward_3d_texture::fragment_shader() noexcept
{
	return
		"	#version 430 core																					\n"
		"	in vec3 moved_XYZ;																					\n"
...
const char* const kiwi::source::forward_3d_normal::vertex_shader() noexcept
{
	return
		"	#version 430 core																					\n"
		"	layout (location = 0) in vec3 in_XYZ;																\n"
...
const char* const kiwi::source::forward_3d_normal::fragment_shader() noexcept
{
	return
		"	#version 430 core																					\n"
		"	in vec3 moved_XYZ;																					\n"
...
const char* const kiwi::source::forward_3d_parallax::vertex_shader() noexcept
{
	return
		"	#version 430 core																					\n"
		"	layout (location = 0) in vec3 in_XYZ;																\n"
...
const char* const kiwi::source::forward_3d_parallax::fragment_shader() noexcept
{
	return
		"	#version 430 core																					\n"
		"	in vec3 moved_XYZ;																					\n"
