...
const char* const kiwi::source::forward_2d_color_gradient_sRMEC::vertex_shader() noexcept
{
	return
		"	#version 330 core																					\n"
		"	layout (location = 0) in vec3 in_XY;																\n"
...
const char* const kiwi::source::forward_2d_color_gradient_sRMEC::fragment_shader() noexcept
{
	return
		"	#version 430 core																					\n"
		"	in vec2 XY;																							\n"
...
const char* const kiwi::source::forward_2d_texture_sRMEC::vertex_shader() noexcept
{
	return
		"	#version 330 core																					\n"
		"	layout (location = 0) in vec3 in_XY;																\n"
...
const char* const kiwi::source::forward_2d_texture_sRMEC::fragment_shader() noexcept
{
	return
		"	#version 430 core																					\n"
		"	in vec2 XY;																							\n"
...
const char* const kiwi::source::forward_2d_texture_vRMEC::vertex_shader() noexcept
{
	return
		"	#version 330 core																					\n"
		"	layout (location = 0) in vec3 in_XY;																\n"
...
const char* const kiwi::source::forward_2d_texture_vRMEC::fragment_shader() noexcept
{
	return
		"	#version 430 core																					\n"
		"	in vec2 XY;																							\n"
...
const char* const kiwi::source::forward_2d_normal_sRMEC::vertex_shader() noexcept
{
	return
		"	#version 330 core																					\n"
		"	layout (location = 0) in vec3 in_XY;																\n"
...
const char* const kiwi::source::forward_2d_normal_sRMEC::fragment_shader() noexcept
{
	return
		"	#version 430 core																					\n"
		"	in vec3 moved_XYZ;																					\n"
...
const char* const kiwi::source::forward_2d_normal_vRMEC::vertex_shader() noexcept
{
	return
		"	#version 330 core																					\n"
		"	layout (location = 0) in vec3 in_XY;																\n"
...
const char* const kiwi::source::forward_2d_normal_vRMEC::fragment_shader() noexcept
{
	return
		"	#version 430 core																					\n"
		"	in vec3 moved_XYZ;																					\n"
