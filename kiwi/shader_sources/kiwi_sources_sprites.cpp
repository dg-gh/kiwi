...
const char* const kiwi::source::solid_color_sprites_2d::vertex_shader() noexcept
{
	return
		...
		"	struct XYZA_RGBA_t { vec4 XYZA; vec4 RGBA; };						\n"
		"	layout (std430, binding = 0) buffer s_XYZA_RGBA {					\n"
		"		XYZA_RGBA_t XYZA_RGBA[];										\n"
		"	};																	\n"
		"	out vec4 RGBA;														\n"
		...
		"	void main()															\n"
		"	{																	\n"
		"		RGBA = XYZA_RGBA[gl_InstanceID].RGBA;							\n"
		"		float C = cos(XYZA_RGBA[gl_InstanceID].XYZA[3]);				\n"
		"		float S = sin(XYZA_RGBA[gl_InstanceID].XYZA[3]);				\n"
		"		vec3 XY = u_mvp_M * vec3(vec2(XYZA_RGBA[gl_InstanceID].XYZA)	\n"
		"			+ mat2(C, S, -S, C) * in_XY, 1.0);							\n"
		"		gl_Position.xy = XY.xy;											\n"
		"		gl_Position.zw = vec2(XYZA_RGBA[gl_InstanceID].XYZA[2], 1.0);	\n"
		"	}																	\n"
		;
}
...
const char* const kiwi::source::solid_color_sprites_split_2d::vertex_shader() noexcept
{
	return
...
const char* const kiwi::source::solid_color_sprites_split_2d::fragment_shader() noexcept
{
	return
...
const char* const kiwi::source::texture_sprites_2d::vertex_shader() noexcept
{
	return
		...
		"	#version 430 core																\n"
		"	struct XYZA_UV_t { vec4 XYZA; vec2 UV; };										\n"
		"	layout (std430, binding = 0) buffer s_XYZA_UV_shift {							\n"
		"		XYZA_UV_t[] XYZA_UV;														\n"
		"	};																				\n"
		"	out vec2 _UV;																	\n"
		"	uniform mat3 u_mvp_M;															\n"
		...
		"		_UV = XYZA_UV[quad_instance_id].UV											\n"
		"			+ quad_UV[quad_vertex_id] * u_XY_UV_size.zw;							\n"

		"		float C = cos(XYZA_UV[quad_instance_id].XYZA[3]);							\n"
		"		float S = sin(XYZA_UV[quad_instance_id].XYZA[3]);							\n"
		"		vec3 XY = u_mvp_M * vec3(vec2(XYZA_UV[quad_instance_id].XYZA)				\n"
		"			+ mat2(C, S, -S, C) * (vec2(u_XY_UV_size) * quad_XY[quad_vertex_id]),	\n"
		"			1.0);																	\n"

		"		gl_Position.xy = XY.xy;														\n"
		"		gl_Position.zw = vec2(XYZA_UV[quad_instance_id].XYZA[2], 1.0);				\n"
		"	}																				\n"
		;
}
...
const char* const kiwi::source::texture_sprites_split_2d::vertex_shader() noexcept
{
	return
...
const char* const kiwi::source::texture_sprites_split_2d::fragment_shader() noexcept
{
	return
...
const char* const kiwi::source::solid_color_sprites_3d::vertex_shader() noexcept
{
	return
		...
		"		gl_Position = u_mvp_M_3d * vec4(XYZA_RGBA[gl_InstanceID]		\n"
		"			.XYZA.xyz, 1.0);											\n"
		"		if (u_depth_scaling == 0)										\n"
		"		{																\n"
		"			gl_Position.xy += gl_Position[3] * XY.xy;					\n"
...
const char* const kiwi::source::solid_color_sprites_split_3d::vertex_shader() noexcept
{
	return
...
const char* const kiwi::source::solid_color_sprites_split_3d::fragment_shader() noexcept
{
	return
...
const char* const kiwi::source::texture_sprites_3d::vertex_shader() noexcept
{
	return
		...
		"		gl_Position = u_mvp_M_3d * vec4(vec3(XYZA_UV[quad_instance_id].XYZA), 1.0);	\n"
		"		if (u_depth_scaling == 0)													\n"
		"		{																			\n"
		"			gl_Position.xy += gl_Position[3] * XY.xy;								\n"
		"		}																			\n"
...
const char* const kiwi::source::texture_sprites_split_3d::vertex_shader() noexcept
{
	return
...
const char* const kiwi::source::texture_sprites_split_3d::fragment_shader() noexcept
{
	return
