...
namespace kiwi
{
	namespace source
	{
		...
		namespace deferred_3d_color_gradient_sRMEC
		{
			const char* const vertex_shader() noexcept;
			const char* const fragment_shader() noexcept;
		}
		...
		namespace deferred_3d_texture_sRMEC
		{
			const char* const vertex_shader() noexcept;
			const char* const fragment_shader() noexcept;
		}

		namespace deferred_3d_texture_vRMEC
		{
			const char* const vertex_shader() noexcept;
			const char* const fragment_shader() noexcept;
		}
		...
		namespace deferred_3d_normal_sRMEC
		{
			const char* const vertex_shader() noexcept;
			const char* const fragment_shader() noexcept;
		}

		namespace deferred_3d_normal_vRMEC
		{
			const char* const vertex_shader() noexcept;
			const char* const fragment_shader() noexcept;
		}

		namespace deferred_3d_normal_mRMEC
		{
			const char* const vertex_shader() noexcept;
			const char* const fragment_shader() noexcept;
		}

		namespace deferred_3d_parallax_sRMEC
		{
			const char* const vertex_shader() noexcept;
			const char* const fragment_shader() noexcept;
		}

		namespace deferred_3d_parallax_vRMEC
		{
			const char* const vertex_shader() noexcept;
			const char* const fragment_shader() noexcept;
		}
