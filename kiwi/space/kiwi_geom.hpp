...
template <class _Allocator> inline void kiwi::_load_frame_proxy::with_N_from_lines_2d(kiwi::orient orientation, const GLfloat* const vertex_ptr, std::size_t vertex_count, std::size_t vertex_dim)
{
...
template <class _Allocator> inline void kiwi::_load_frame_proxy::with_TB_from_triangles_2d(const GLfloat* const vertex_ptr, const GLfloat* const uv_ptr, std::size_t vertex_count, std::size_t vertex_dim)
{
...
template <class _Allocator> inline void kiwi::_load_frame_proxy::with_TB_from_quads_2d(const GLfloat* const vertex_ptr, const GLfloat* const uv_ptr, std::size_t vertex_count, std::size_t vertex_dim)
{
	std::vector<GLfloat, _Allocator> temp(vertex_count * 4);
...
template <class _Allocator> inline void kiwi::_load_frame_proxy::with_N_from_triangles_3d(kiwi::orient orientation, const GLfloat* const vertex_ptr, std::size_t vertex_count, std::size_t vertex_dim)
{
...
template <class _Allocator> inline void kiwi::_load_frame_proxy::with_N_from_quads_3d(kiwi::orient orientation, const GLfloat* const vertex_ptr, std::size_t vertex_count, std::size_t vertex_dim)
{
	std::vector<GLfloat, _Allocator> temp(vertex_count * 3);
...
template <class _Allocator> inline void kiwi::_load_frame_proxy::with_TBN_from_triangles_3d(kiwi::orient orientation, const GLfloat* const vertex_ptr, const GLfloat* uv_ptr,
...
template <class _Allocator> inline void kiwi::_load_frame_proxy::with_TBN_from_quads_3d(kiwi::orient orientation, const GLfloat* const vertex_ptr, const GLfloat* uv_ptr,
	std::size_t vertex_count, std::size_t vertex_dim)
{
	std::vector<GLfloat, _Allocator> temp(vertex_count * 9);
